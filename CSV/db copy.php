...
if (isset($_POST['submit'])) {
    ...
    if (in_array($_FILES['file']['type'], $mimes)) {
        ...
        while (!feof($file_open)) {
            ...
            $query = "INSERT INTO $tablename (First_Name, Last_Name, Company, Company_Name_for_Emails, Email_ok, Email_Status, Email_Confidence) VALUES ('" . $csv[0] . "', '" . $csv[1] . "', '" . $csv[2] . "', '" . $csv[3] . "', '" . $csv[4] . "', '" . $csv[5] . "', '" . $csv[6] . "')";
